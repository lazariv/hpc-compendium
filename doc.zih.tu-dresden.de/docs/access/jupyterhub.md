...
work with Jupyter notebooks on ZIH systems.
...
This service is provided "as-is", use at your own discretion.
...
You can choose between JupyterLab or classic Jupyter notebooks.
...
This message often appears instantly if your Slurm parameters are not valid.
